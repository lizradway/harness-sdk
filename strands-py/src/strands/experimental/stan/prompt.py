...
``HARNESS_CONTRACT`` is a model-neutral behavioral contract that gets harness-like behavior
out of a capable model: act once there is enough to act on, explore before changing things,
confirm before anything irreversible, verify before declaring a task done.
"""
...
def build_system_prompt(
    ...
    Args:
        instructions: A domain block appended after the contract.
        context_parts: Additional blocks appended last.
